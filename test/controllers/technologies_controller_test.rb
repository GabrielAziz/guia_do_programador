...
class TechnologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technology" do
    assert_difference("Technology.count") do
      post technologies_url, params: { technology: { icon: @technology.icon, name: @technology.name } }
    end
  ...
  test "should update technology" do
    patch technology_url(@technology), params: { technology: { icon: @technology.icon, name: @technology.name } }
